class Round {
  ...
  getClues(roundCats) {
    this.clues = roundCats.reduce((acc, categoryId) => {
  ...
  setDailyDouble() {
    let sortedArray = this.clues.sort((a, b) => 0.5 - Math.random());
    if (this.roundNum === 2) {
      sortedArray[0].dailyDouble = true;
      sortedArray[1].dailyDouble = true;
    } else {
      sortedArray[0].dailyDouble = true;
    }
  }
